...
public class MqttServerVerticle extends AbstractVerticle {
	...
	public static final String TOPIC_SENSORES_PARTICULA_VALUE = "sensoresParticulaValue";
	public static final String TOPIC_SENSORES_DHT11_VALUE = "sensoresDht11Value";
	
	public static final String TOPIC_ACTUADORES_ALARMA_VALUE = "actuadoresAlarmaValue";
	public static final String TOPIC_ACTUADORES_LCD_VALUE = "actuadoresLcdValue";
	...
	private static void handleQoS(MqttPublishMessage message, MqttEndpoint endpoint) {
		if (message.qosLevel() == MqttQoS.AT_LEAST_ONCE) {
			...
			switch (topicName) {
			case TOPIC_SENSORES_PARTICULA_VALUE:
				System.out.println("Sensores Particulas published");
				break;
			case TOPIC_SENSORES_DHT11_VALUE:
				System.out.println("Sensores dht11 published");
				break;
			case TOPIC_ACTUADORES_ALARMA_VALUE:
				System.out.println("Actuadores alarma published");
				break;
			case TOPIC_ACTUADORES_LCD_VALUE:
				System.out.println("Actuadores LCD published");
				break;
			}
